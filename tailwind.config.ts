  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        ds: {
          nav: "hsl(var(--ds-nav))",
          "nav-foreground": "hsl(var(--ds-nav-foreground))",
          ...
          "text-tertiary": "hsl(var(--ds-text-tertiary))",
          bull: "hsl(var(--ds-bull))",
          base: "hsl(var(--ds-base))",
          bear: "hsl(var(--ds-bear))",
          custom: "hsl(var(--ds-custom))",
          positive: "hsl(var(--ds-positive))",
          negative: "hsl(var(--ds-negative))",
      ...
      animation: {
        ...
        "pulse-subtle": "pulse-subtle 1.5s ease-in-out 1",
      },
    },
  },
